function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello and welcome to Everquest Underground! The server is still very WIP so expect bugs and weird things. Visit us on Discord at discord.gg/WswdAAnhS9 for more information. Would you like to hear about our " .. eq.say_link("What features?", false, "features") .. "?")
